...
class ProducttypeService extends Service {
    ...
    async findOne(params) {
        const ctx = this.ctx;
        var res = await ctx.model.Producttype.findByPk(params.id);
    ...
    async list(params) {
        ...
        const list = await ctx.model.Producttype.findAndCountAll(obj)
    ...
    async del(params) {
        ...
        const ctx = this.ctx;
        let res = await ctx.model.Producttype.destroy({
            where: {
                id: params.id
            }
        })
    ...
    async mod(params) {
        ...
        const ctx = this.ctx;
        const user = await ctx.model.Producttype.findByPk(params.id);
